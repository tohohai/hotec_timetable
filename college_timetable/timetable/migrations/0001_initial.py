    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sessions_per_week', models.IntegerField(default=2, verbose_name='Số buổi/tuần dự kiến (để engine auto xếp)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('component', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='timetable.assessmentcomponent', verbose_name='Thuộc thành phần đánh giá')),
                ('course_section', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='exams', to='timetable.coursesection', verbose_name='Lớp học phần')),
            ],
            options={
        ...
        migrations.CreateModel(
            name='ExamInvigilationAssignment',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('role', models.CharField(choices=[('GT1', 'Giám thị 1'), ('GT2', 'Giám thị 2'), ('RESERVE', 'Giám thị dự phòng')], max_length=20, verbose_name='Vai trò trong ca thi')),
                ('exam_session', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='invigilation_assignments', to='timetable.examsession', verbose_name='Ca thi')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='invigilators',
            field=models.ManyToManyField(blank=True, related_name='invigilated_exams', through='timetable.ExamInvigilationAssignment', to='timetable.instructor', verbose_name='Giám thị'),
        ),
        migrations.AddField(
            model_name='examinvigilationassignment',
            name='instructor',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='exam_invigilation_assignments', to='timetable.instructor', verbose_name='Giảng viên'),
        ),
        migrations.CreateModel(
            name='ExamGradingAssignment',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('role', models.CharField(choices=[('GK1', 'Giám khảo 1'), ('GK2', 'Giám khảo 2'), ('REVIEW', 'Phúc khảo/Chấm lại')], max_length=20, verbose_name='Vai trò chấm thi')),
                ('start_date', models.DateField(blank=True, null=True, verbose_name='Ngày bắt đầu chấm')),
                ('end_date', models.DateField(blank=True, null=True, verbose_name='Ngày kết thúc chấm')),
                ('exam_session', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='grading_assignments', to='timetable.examsession', verbose_name='Ca thi')),
                ('instructor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='exam_grading_assignments', to='timetable.instructor', verbose_name='Giảng viên chấm thi')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('hours', models.FloatField(default=0, verbose_name='Số giờ NCKH')),
                ('topic_name', models.CharField(max_length=255, verbose_name='Tên đề tài')),
                ('instructor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='timetable.instructor', verbose_name='Giảng viên')),
                ('year', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='timetable.academicyear', verbose_name='Năm học')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start_date', models.DateField(verbose_name='Ngày bắt đầu (Tuần 1)')),
                ('weeks', models.IntegerField(default=15, verbose_name='Tổng số tuần (không tính tuần nghỉ)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start_date', models.DateField(verbose_name='Ngày bắt đầu tuần')),
                ('end_date', models.DateField(verbose_name='Ngày kết thúc tuần')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subject_type', models.CharField(choices=[('LT', 'Lý thuyết'), ('TH', 'Thực hành'), ('TICH_HOP', 'Tích hợp'), ('THUC_TAP', 'Thực tập ngoài trường')], max_length=20, verbose_name='Loại môn')),
        ...
        migrations.AddField(
            ...
            name='subject',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='assessments', to='timetable.subject', verbose_name='Môn học'),
        ),
        migrations.CreateModel(
            name='SubjectChapter',
            fields=[
